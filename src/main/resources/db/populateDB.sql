...
INSERT INTO currentstatus (statusId, statusName, statusDate, statusGroup, product_id, id) VALUES
  ...
  (4, 'Обработан', '2016-05-13', 4, 10003, 1003),

  (5, 'Не_заказан', '2016-05-13', 4, 10003, 1003),
  (6, 'Заказан', '2016-05-13', 4, 10003, 1003),
  (7, 'Отсутствует', '2016-05-13', 4, 10003, 1003),
  (8, 'Проверен_и_отложен', '2016-05-13', 4, 10003, 1003),
  (9, 'Дозвон', '2016-05-13', 4, 10003, 1003),
  (10, 'Не_Звонили', '2016-05-13', 4, 10003, 1003),
  (11, 'Дозвон', '2016-05-13', 4, 10003, 1003),
  (12, 'Не_выдан', '2016-05-13', 4, 10003, 1003),
  (13, 'Выдан', '2016-05-13', 4, 10003, 1003);
