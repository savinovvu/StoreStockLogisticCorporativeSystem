							...
							<form action="" class="new-order-form">
								<div class="new-order-form-row row">
									...
									<fieldset class="col-sm-3">
										...
										<input type="text" class="form-control" value="Товар">
									</fieldset>
									<fieldset class="col-sm-2">
										<label for="">Количество товара</label>
										<input type="text" value="1" class="form-control" data-input="number">
									</fieldset>
									<fieldset class="col-sm-2">
										<label for="">Ориентировочная дата поставки</label>
										<input type="text" class="form-control" value="12/12/16" data-input="date">
									</fieldset>
									<fieldset class="col-sm-1">
										<label for="">Предоплата</label>
										<input type="text" class="form-control" value="2000" data-input="number">
									</fieldset>
									<div class="new-row remove" data-toggle="remove-row"><i class="fa fa-times-circle" aria-hidden="true"></i>&nbspУдалить товар</div>
								</div>
								<div class="new-order-form-row row">
									<fieldset class="col-sm-2">
										<label for="">Артикул</label>
									...
									<fieldset class="col-sm-1">
										<label for="">Предоплата</label>
										<input type="text" class="form-control" data-input="number">
									</fieldset>
								...
								<div class="new-order-form-row bottom row">
									<div class="col-sm-4">
										...
										<fieldset>
											...
											<input type="text" class="form-control" data-input="phone" required>
										</fieldset>
									</div>
								...
								<div class="btn-wrapper">
									<input type="submit" class="btn btn-success btn-lg"value="Сохранить и распечатать">
								</div>
							</form>
						</div>
					</div>
